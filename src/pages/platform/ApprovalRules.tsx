...
interface ApprovalRule {
  ...
  priority: number
  appliesTo: string[]
  approverType: 'Fixed' | 'Dynamic' | 'Hierarchical'
...
const approvalRules: ApprovalRule[] = [
  ...
  { id: 'AR-004', name: 'Invoice < AED 10K - Finance Ops', description: 'Standard invoices approved by finance operations', ruleType: 'Amount-Based', status: 'Active', priority: 10, appliesTo: ['Invoice Processing'], approverType: 'Role-Based', approverCount: 1, requiresSequential: false, requiresUnanimous: false, servicesLinked: 4, executionCount: 623, lastModified: '16 May 2026', modifiedBy: 'Sara Pereira' },
  ...
  { id: 'AR-014', name: 'Asset Assignment < AED 5K - IT Manager', description: 'Standard asset assignments approved by IT manager', ruleType: 'Amount-Based', status: 'Active', priority: 10, appliesTo: ['Asset Assignment'], approverType: 'Role-Based', approverCount: 1, requiresSequential: false, requiresUnanimous: false, servicesLinked: 9, executionCount: 278, lastModified: '14 May 2026', modifiedBy: 'Rashid Ahmed' },
